...
//  ImageZoomScrollView
//
//  Created by evan3rd on 2020/11/17.
//  Copyright © 2020 evan3rd. All rights reserved.
//

import UIKit

protocol ImageViewZoomDelegate: UIScrollViewDelegate {
    func imageScrollViewDidChangeOrientation(imageViewZoom: ImageZoomScrollView)
}

open class ImageZoomScrollView: UIScrollView {
    ...
    weak var imageScrollViewDelegate: ImageViewZoomDelegate?
    ...
    private func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ImageZoomScrollView.changeOrientationNotification), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    @objc open func display(image: UIImage) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(ImageZoomScrollView.doubleTapGestureRecognizer(_:)))
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= maximumZoomScale / 2.0 {
            ...
            let zoomRect = zoomRectForScale(ImageZoomScrollView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
